# Generated by Django 2.0.13 on 2020-01-17 18:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_notes', models.TextField(blank=True, help_text='Only users with errata admin access can view and edit the contents of this field.', null=True)),
                ...
                ('submitted_by_account_id', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), errata.models.is_user_blocked])),
                ('file_1', models.FileField(blank=True, null=True, upload_to='errata/user_uploads/1/')),
                ('file_2', models.FileField(blank=True, null=True, upload_to='errata/user_uploads/2/')),
                ('duplicate_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='duplicate_report', to='errata.Errata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('errata', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='errata.Errata')),
            ],
        ),
    ]
